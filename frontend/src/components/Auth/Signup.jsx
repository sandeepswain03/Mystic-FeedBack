...
//                                 <div class="flex items-center border border-[#393937] rounded-lg bg-[#2C2B28]">
//                                     {/* Input field */}
//                                     <input
//                                         type="text"
//                                         id="otp"
//                                         class="appearance-none rounded-lg block w-full px-4 py-3 text-[#afa18f] bg-[#2C2B28] focus:outline-none focus:ring-2 focus:ring-[#ec4e39] focus:border-[#ec4e39] text-sm sm:text-base transition duration-300"
...
//                                     <button
//                                         type="button"
//                                         class="group relative flex items-center justify-center py-3 px-6 ml-2 bg-[#ec4e39] text-sm sm:text-base font-bold text-[#262622] rounded-full hover:bg-[#d43d2a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ec4e39] transition duration-300 ease-in-out transform hover:scale-105"
//                                     >
//                                         Verify
//                                     </button>
//                                 </div>
